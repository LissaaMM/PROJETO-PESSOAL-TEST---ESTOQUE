...
describe("Testes para gerenciamento de estoque", () => {
    ...
    it("Deve lançar erro ao adicionar item com nome vazio ou quantidade inválida", () => {
        expect(() => estoque.adicionarItem("", 10)).toThrow("Nome do item e quantidade devem ser válidos.");
        expect(() => estoque.adicionarItem("Caneta", 0)).toThrow("Nome do item e quantidade devem ser válidos.");
    });
});
